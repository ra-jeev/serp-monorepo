/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 63fecc12952342e24da815bb0b1ca9eb)
// Runtime types generated with workerd@1.20250924.0 2025-09-27 no_nodejs_compat_v2,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.output/server/index");
	}
	interface Env {
		MUXT_PUBLIC_SITE_NAME: "SERP STAGING" | "SERP";
		MUXT_PUBLIC_SITE_URL: "https://serp-co-staging.rajeevs.workers.dev" | "https://serp-co.rajeevs.workers.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MUXT_PUBLIC_SITE_NAME" | "MUXT_PUBLIC_SITE_URL" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE">> {}
}
